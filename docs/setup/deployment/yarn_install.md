...
description: "This page describes how to pre-configure a bare metal node, configure Apache Submarine and connect it to existing YARN cluster running Hortonworks flavour of Hadoop."
...
Checkout source code from [git://git.apache.org/zeppelin.git](https://github.com/apache/zeppelin.git) or download binary package from [Download page](https://submarine.apache.org/download.html).
