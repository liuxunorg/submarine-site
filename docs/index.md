...
<div class="row" style="margin-top: 0px;">
  <div class="col-sm-6 col-md-6" style="padding-right:0;">
    <h1 style="color:#4c555a; margin-top: 0px;">What is Apache Submarine?</h1>
    <p style="margin-bottom: 0px; margin-top: 20px; font-size: 18px; font-style="font-family: "Roboto", sans-serif;">
      Submarine allows infra engineer/data scientist to run deep learning applications (Tensorflow, Pytorch, etc.) on resource management platform (like YARN).
    </p>
  ...
  <div class="col-sm-6 col-md-6" style="padding:0;">
    <div class="hidden-xs" style="margin-top: 80px;"></div>
    <img class="img-responsive" style="border: 1px solid #ecf0f1;" src="{{BASE_PATH}}/assets/themes/submarine/img/Architecture.png" />
  </div>
</div>
...
* [Quick Start Guide](./quickstart/index.html) for basic instructions on Submarine Quick Start Guide
* [Install](./quickstart/install.html) for basic instructions on installing Apache Submarine
* [Explore UI](./quickstart/explore_ui.html): basic components of Apache Submarine home
...
* Interpreter  
  * [Overview](./usage/interpreter/overview.html): what is interpreter group? how can you set interpreters in Apache Submarine?
...
* REST API: available REST API list in Apache Submarine
...
* Security: available security support in Apache Submarine
...
* Operation 
  * [Configuration](./setup/operation/configuration.html): lists for Apache Submarine
  * [Proxy Setting](./setup/operation/proxy_setting.html)
  * [Upgrading](./setup/operation/upgrading.html): a manual procedure of upgrading Apache Submarine version
...
#### External Resources
  * [Mailing List](https://submarine.apache.org/community.html)
  * [Apache Submarine Wiki](https://cwiki.apache.org/confluence/display/ZEPPELIN/Zeppelin+Home)
